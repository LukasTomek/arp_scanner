...
async def to_code(config):
    ...
    # Force the builder engine to compile the new source file asset
    cg.add_library("lwip", None) # Double-checks core framework linking
    cg.add_sources(["arp_scanner.cpp"])
